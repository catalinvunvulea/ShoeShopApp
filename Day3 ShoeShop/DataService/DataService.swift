...
class DataService {
    ...
    func getProductsFromDB() { // simulate server
        products = [
            Product(imageName: "270", productName: "Nike AirMax 270 react", price: 270.99, stockSize: [0: ["XS": 0], 1: ["S": 0], 2: ["M": 2], 3: ["X": 5], 4: ["XL": 1]], additionalImages: ["270.jpg", "271.jpg"], liked: false, id: "0"),
